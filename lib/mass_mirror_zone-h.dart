...
class MassMirrorZone extends StatelessWidget {
  const MassMirrorZone({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<MassMirrorProvider>(
      builder: (context, provider, child) {
        return _MassMirrorContent(provider: provider);
      },
    );
  }
}

class _MassMirrorContent extends StatefulWidget {
  final MassMirrorProvider provider;

  const _MassMirrorContent({required this.provider});

  @override
  State<_MassMirrorContent> createState() => _MassMirrorContentState();
}

class _MassMirrorContentState extends State<_MassMirrorContent> {
  ...
  Future<void> _performMassMirror() async {
    ...
    await widget.provider.performMassMirror();
  }

  @override
  Widget build(BuildContext context) {
    void aboutMassMirror() {
      showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
            ...
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(
                    'Alat untuk melakukan mass mirror defacement ke Zone-H.org. Tool ini mensimulasikan proses pembuatan mirror defacement pada multiple server Zone-H untuk keperluan security research dan edukasi.\n\n',
                    style: TextStyle(
                      fontSize: 14,
                      color: Colors.white,
                      fontFamily: 'pixels',
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 8),
                          Text(
                            'Create multiple defacement mirrors on Zone-H servers',
                            style: TextStyle(
                              color: Colors.greenAccent.withOpacity(0.8),
                              fontSize: 14,
                              fontFamily: 'pixels',
                            ...
                            Padding(
                              ...
                              child: Text(
                                provider.status == 'loading'
                                    ? '🚀 LAUNCHING MASS MIRROR ATTACK...'
                                    : provider.status == 'success'
                                    ? '✅ MASS MIRROR ATTACK SUCCESS!'
                                    : '❌ MASS MIRROR ATTACK FAILED',
                                style: TextStyle(
                                  color: provider.status == 'success'
                                      ? Colors.greenAccent
                                      : provider.status == 'error'
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  hintText:
                                      'Mass mirror results will appear here...',
                                  hintStyle: TextStyle(
                                    color: Colors.greenAccent.withValues(
                                      alpha: 0.5,
                                    ),
                    ...
                    Center(
                      child: Text(
                        '© 2024 HADI RAMDHANI - ZONE-H MASS MIRROR TOOLS',
                        style: TextStyle(
